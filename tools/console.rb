...
science1 = Magazine.new("Stellar Formations", "Astrophysics")
science2 = Magazine.new("Cloning Monthly", "Practical Biology")
science3 = Magazine.new("The Right Ingredient", "Practical Biology")
